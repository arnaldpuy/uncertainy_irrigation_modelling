...
```{r merge_sa3, dependson=c("merge_sa", "examples_plots", "faceted_plot"), fig.height=6.1, fig.width=5.1}
...
```{r check_metric_effect, dependson=c("forking_paths", "naomi_arrange"), fig.height=1.8, fig.width=5, warning=FALSE}
