---
title: "Uncertainty in global irrigation withdrawals persists after 50 years of research"
subtitle: "R code"
author: "Arnald Puy"
header-includes:
...
```{r plot_naomi, dependson="naomi_data", fig.height=3.2, fig.width=6}
...
## Evolution of uncertainty through time

```{r evolution_uncertainty, dependson="naomi_data", fig.height=2.2, fig.width=2.2, warning=FALSE}
...
```{r merge_unc, dependson=c("evolution_uncertainty", "plot_naomi"), fig.height=5.5, fig.width=6, warning=FALSE}
